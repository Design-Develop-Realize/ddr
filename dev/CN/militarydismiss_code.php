...
if ($_POST["confirm"]!=1)
{
  ...
  $denyreason_session="You must click the checkbox to confirm dismissal of your soldiers.";
...
if ($rsGuestbook["Military_Sold_Date"]>time()()-1)
{
  ...
  $denyreason_session="You have already dismissed soldiers within the past 2 days.";
  header("Location: "."activity_denied.asp");
} 
...
if (time()()-$rsGuestbook["Military_Attack_Date1"]<2 || time()()-$rsGuestbook["Military_Attack_Date2"]<2)
{
  ...
  $denyreason_session="You cannot dismiss soliders after having attacked an opponent within the past 2 days.";
  header("Location: "."activity_denied.asp");
} 
...
$rsGuestbook["Military_Purchased"]=($rsGuestbook["Military_Purchased"]-$newsell);
$rsGuestbook["Military_Deployed"]=0;
$rsGuestbook["Military_Sold_Date"]=time()();


if (($actualmilitary-$newsell)<=($actualmilitary*40))
{

$rsGuestbook["Military_Depleated"]=time()();
  $rsGuestbook["Government_Type"]="Anarchy";
  $rsGuestbook["Government_Changed"]=time()();
  } 

if (($actualmilitary>30) && ($actualmilitary-$newsell<10))
{
