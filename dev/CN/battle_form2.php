...
?>
<? 
if request.form("attackingnation") = "" then%>
...
// $rsDefend is of type "ADODB.Recordset"
    ...
    echo $MM_conn_STRING;
    echo "SELECT * FROM Nation WHERE Nation_ID='".intval($_GET["Nation_ID"])."' ";
    echo 0;
    echo 2;
    echo 3;
  $rs=mysql_query();
...
// $rsSent is of type "ADODB.Recordset"
  ...
  switch ($_GET["type"])
  {
    ...
    default:
      ...
      $denyreason_session="You must select a valid ground attack attackType.";
...
<form name="FrontPage_Form1" method="post" action="battle_form_code2.php">      
...
You cannot attack at this time. Your attacking odds are currently at <?         echo $attackingchance; ?>% and are not high enough to battle <?         echo (.$Item["Nation_Name"].$Value); ?> at this time. You mist have at least a 10% chance of victory in order to battle.<br>
...
<p><img border="0" src="http://images.cybernations.net/images/battle1.jpg"></p>
<p>&nbsp;</p>
</div></td>
</tr>
</table>
