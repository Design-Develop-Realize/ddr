...
$rsGuestbookSQL="SELECT Last_Tax_Collection,Strength,Cruise_Purchased,Poster,Nation_ID,Nation_Name,Nation_Dated,Nation_Team,Land_Purchased,Infrastructure_Purchased,Technology_Purchased,Nuclear_Purchased,Nation_Peace,Nuclear FROM Nation ORDER BY Strength DESC ";
echo 3;
echo 2;
echo 3;
...
All Nations By Strength Rank</b><? if (!($rsGuestbook==0) || !($rsGuestbook_BOF==1))
{
?>
                              
<form method="post" action="stats_ranking.php">
View Top <select size="1" name="range">
...
<input name="imageField" type="image" id="imageField" src="assets/go.gif" width="21" height="14" border="0">
</form>
