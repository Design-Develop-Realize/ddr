...
$lngRecordNo=$_GET["Alliance"];
$rsGuestbookSQL="SELECT Top ".intval($nukecapable)." Strength,Last_Tax_Collection,Cruise_Purchased,Poster,Nation_ID,Nation_Name,Nation_Dated,Nation_Team,Land_Purchased,Infrastructure_Purchased,Technology_Purchased,Nuclear_Purchased,Nation_Peace,Nuclear FROM Nation ORDER BY Strength DESC ";
echo 3;
echo 2;
echo 3;
...
All Nuclear Capable Nations By Strength Rank</b><? if (!($rsGuestbook==0) || !($rsGuestbook_BOF==1))
{
?>
                              </p>
                              <p align="center">
...
<?   echo mysql_num_rows($rsGuestbook_query); ?> Nuclear Capable Nations
