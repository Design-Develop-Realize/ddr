...
if ($defendingsoldierstest<10 && $rsDefend["Military_Deployed"]>0)
{
...
if ($defendingchance==0)
{
  $attackingchance=100;
}
;
} 
if ($attackingchance==0)
{
  $defendingchance=100;
}
;
...
if ($_POST["type"]!="")
{
  ...
  switch ($_POST["type"])
  {
    ...
    case "Standard Ground Attack":
      ...
      if ($attackingsoldiercasualties>$defendingsoldiercasualties*275)
      {
        $attackingsoldiercasualties=$defendingsoldiercasualties*2.75;
      } 
      if ($defendingsoldiercasualties>$attackingsoldiercasualties*275)
      {
        $defendingsoldiercasualties=$attackingsoldiercasualties*2.75;
      } 
      break;
    case "Planned Ground Attack":
      ...
      if ($attackingsoldiercasualties>$defendingsoldiercasualties*35)
      {
        $attackingsoldiercasualties=$defendingsoldiercasualties*3.5;
      } 
      if ($defendingsoldiercasualties>$attackingsoldiercasualties*35)
      {
        $defendingsoldiercasualties=$attackingsoldiercasualties*3.5;
      } 
      break;
...
if ($defendingtanks-$defendingtankcasualties<0)
{
  $defendingtankcasualties=$defendingtanks;
}
;
} 
if ($attackingtanks-$attackingtankcasualties<0)
{
  $attackingtankcasualties=$attackingtanks;
}
;
} 
