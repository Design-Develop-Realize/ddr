...
if (${"search"}!="")
{
  ...
  if (${"searchstring"}=="" || ${"searchstring"}=="All")
  {
    ...
    $tfm_databaseFields=$Split["Nation_Name,Poster,Resource1,Resource2,Nation_Team,Alliance"][","];
  }
    else
  {
...
($rsAds==0)$Or$Not($rsAds_BOF==1)$Then; ?>
											...
											<!--#include file="search_sanctions_code.php" -->
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form action="search_sanctions.php" method="get" name="FrontPage_Form1" id="dirsearch" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript">
<table border="1" width="100%" id="table1" cellspacing="0" cellpadding="5" bordercolor="#000080">
	<tr>
		<td width="50%">
		<p align="right">Search For Nations To Sanction:</td>
