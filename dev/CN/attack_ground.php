...
if (("Military_Attack_Date2")==time()())
{

  $denyreason_session="You have already been in battle twice today and cannot battle again until tomorrow.";
  header("Location: "."activity_denied.asp");
}
  else
{

  if (("Military_Attack_Date1")==time()())
  {

    //Military_Attack_Date2") = date()  }
    else
  {

    //Military_Attack_Date1") = date()  } 
