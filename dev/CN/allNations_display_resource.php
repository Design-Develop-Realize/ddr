...
$rsGuestbookSQL="SELECT Top 300 Last_Tax_Collection,Poster,Nation_Name,Nation_ID,Nation_Dated,Nation_Team,Resource1,Resource2 FROM Nation "+$tfm_SQLstr+" ORDER BY "+str_replace("'","''",$rsGuestbook__sql_orderby)+"";
echo 0;
echo 2;
echo 3;
...
{
?>
                              <p align="center"><b>All Nations Resources</b></p>
                              <p align="center">
