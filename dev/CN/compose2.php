...
function FrontPage_Form1_Validator(theForm)
{
  ...
  if (theForm.messaging_toid.value == "")
  {
    alert("Please enter a value for the \"Recipient Ruler Name\" field.");
    theForm.messaging_toid.focus();
    return (false);
  }

  if (theForm.messaging_toid.value.length > 50)
  {
                            ...
                            <table width="100%" 
                              ...
                              <tbody>
                                <tr bgcolor="5E6C50" class=colorformheader> 
                                  ...
                                  <p align="left"><font color="#FFFFFF"><b><font class=textsize9>&nbsp;:. Compose 
                                    A Message</font></td>
                                </tr>
                                <?   if ($failed==1)
  {
?>
                                ...
                                class=textsize9> Ruler Name:</font></td>
                                  <td width="69%"><font class=textsize9> 
									...
									<!--webbot bot="Validation" s-display-name="Recipient Ruler Name" b-value-required="TRUE" i-maximum-length="50" --><input type=text name="messaging_toid" value="<?   echo $messageto; ?>" size="30" maxlength="50">
                                 &nbsp;</font></td>
                                </tr>
...
<input type='button' class=Buttons name='findusers' onclick='find_users()' value='Search for users' /><i>
                                ...
                                name=messaging_subject value="<?   echo $_POST["messaging_subject"]; ?>">
