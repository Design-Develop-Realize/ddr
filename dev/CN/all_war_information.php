...
$rsSentSQL="SELECT Declaring_Team,Receiving_Team,War_Declaration_Date,War_End_Date,Declaring_Nation_ID,Declaring_Nation,War_Declared_By_User,Receiving_Nation_ID,Receiving_Nation,War_Declared_On_User,War_Reason,Receiving_Nation_Peace,Declaring_Nation_Peace,Nation_Deleted FROM WAR ORDER BY War_Declaration_Date DESC";
echo 0;
echo 2;
echo 3;
...
// $rsAllUsers is of type "ADODB.Recordset"
    ...
    echo $MM_conn_STRING;
    echo "SELECT COUNT(Declaring_Nation_ID) AS CADS FROM War";
    echo 0;
    echo 2;
    echo 3;
  $rs=mysql_query();
  ...
  $rsSent_total=$FormatNumber[$rsAllUsers["CADS"]][0];
// While (Not rsSent.EOF)
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="0" align="left" valign="middle">
                              <p align="center"><b>All Wars Across the Globe</b></p>
...
Serving <?   echo ($rsSent_first); ?> to <?   echo ($rsSent_last); ?> of                                
<? 
// Count the number of nations before the deletion
...
// $rsAllUsers is of type "ADODB.Recordset"
  ...
  $rsAllUsers_numRows=0;
?>
<?   echo $FormatNumber[$rsAllUsers["CADS"]][0]; ?> Wars
