...
echo $MM_conn_STRING;
echo "SELECT *  FROM Nation "+$tfm_SQLstr+" Order By Last_Tax_Collection Desc";
echo 1;
echo 2;
echo 3;
$rs=mysql_query();
...
($rsAds==0)$Or$Not($rsAds_BOF==1)$Then; ?>
											...
											Search Results</font>
											<p>
											Your search for <? echo ${"search"}; ?> returned <? echo $test; ?> results.
											
											</strong></center>
											</p>

 
											<!--#include file="search_code.php" -->
