...
$rsSentSQL="SELECT * FROM Aid ORDER BY Aid_Declaration_Date DESC";
echo 0;
echo 2;
echo 3;
...
// $rsAllUsers is of type "ADODB.Recordset"
    ...
    echo $MM_conn_STRING;
    echo "SELECT COUNT(Declaring_Nation_ID) AS CADS FROM Aid";
    echo 0;
    echo 2;
    echo 3;
  $rs=mysql_query();
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="0" align="left" valign="middle">
                              <p align="center"><b>All Foreign Aid Offers Across the Globe</b></p>
...
// $rsAllUsers is of type "ADODB.Recordset"
  ...
  $rsAllUsers_numRows=0;
?>
<?   echo $FormatNumber[$rsAllUsers["CADS"]][0]; ?> Foreign Aid Agreements
