...
$rsGuestbookSQL="SELECT Poster,Nation_ID,Nation_Name,Nation_Dated,Nation_Team,Land_Purchased,Infrastructure_Purchased,Technology_Purchased,Nuclear_Purchased,Nation_Peace,Nuclear FROM Nation Where Nation_Team = '"+$lngRecordNo+"' "+$tfm_SQLstr+" ORDER BY "+str_replace("'","''",$rsGuestbook__sql_orderby)+"";
echo 3;
echo 2;
echo 3;
...
{
?><font color="<?   echo $lngRecordNo; ?>"><?   echo $lngRecordNo; ?>
<? } ?> Team</font></b></p></b>
...
?>
                              <p align="center">
								...
								<a href="allNations_display_teams.php?Team=Orange">Orange</a><br> 
								...
								<a href="allNations_display_teams.php?Team=None">No Team</a></p>
