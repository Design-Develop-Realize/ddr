...
$lngRecordNo=str_replace("'","''",$_GET["Team"]);
$rsGuestbookSQL="SELECT Last_Tax_Collection,Strength,Cruise_Purchased,Poster,Nation_ID,Nation_Name,Nation_Dated,Nation_Team,Land_Purchased,Infrastructure_Purchased,Technology_Purchased,Nuclear_Purchased,Nation_Peace,Nuclear FROM Nation Where Nation_Team = '"+$lngRecordNo+"'  ORDER BY Strength DESC ";
echo 3;
echo 2;
echo 3;
...
<?   }
  ...
  {
?>
<?     echo $lngRecordNo; ?> Team Rankings
<?   } ?>
</b>
                              </p>
                              <p align="center">
