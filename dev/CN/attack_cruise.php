...
$techmod=(("Technology_Purchased")/100);
if ($techmod>30)
{
  $techmod=.30;
}
  ...
  else
{
  ...
  $highestNumber=$highestNumber+($highestNumber*($satellites*.30));
  $highestNumber=$highestNumber-($highestNumber*($missile_defenses*.30));
  ...
  else
{
  ...
  $clear=(mt_rand(0,10000000)/10000000); //clear the random number generator
;
  if ($cruiseinfrastructure>8)
  {
    $cruiseinfrastructure=8;
  }
;
  } 
} 
...
$cruiseinfrastructure=$cruiseinfrastructure+($cruiseinfrastructure*($satellites*.30));
$cruiseinfrastructure=$cruiseinfrastructure-($cruiseinfrastructure*($missile_defenses*.30));
$cruisetanks=$cruisetanks+($cruisetanks*($satellites*.30));
$cruisetanks=$cruisetanks-($cruisetanks*($missile_defenses*.30));
...
<table border="1" width="100%" cellspacing="0" cellpadding="5" bgcolor="#F7F7F7" bordercolor="#000080" id="table1">
		...
		<tr>
			<td width="50%">
			<p align="center">
			<img border="0" src="http://images.cybernations.net/images/cruisestrike.jpg" width="570" height="285"></p>
