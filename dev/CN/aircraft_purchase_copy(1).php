...
?>
	...
	<?     if ($totalaircraft>=$aircraftlimit || $rsGuestbook["Infrastructure_Purchased"]<100 || $rsGuestbook["Technology_Purchased"]<10 || $totalmoneyavailable-$f1<0)
    {
?>
		<tr>
		<td valign="top" colspan="2">
		<?       if ($rsGuestbook["Infrastructure_Purchased"]<100 || $rsGuestbook["Technology_Purchased"]<10 || $totalmoneyavailable-$f1<0 || $totalmoneyavailable-$b1<0)
      {
?>
		...
		need at least 100 infrastructure, 10 technology levels, and $<?         echo $FormatNumber[$f1][0]; ?>.
		<?       } ?>
...
?>
    ...
    {
?>
	You do not have enough infrastructure, technology, or money to purchase aircraft at this time. To purchase that aircraft you
	need at least <?       echo $item_infras; ?> infrastructure, <?       echo $item_tech; ?> technology levels, and $<?       echo $FormatNumber[$itemcost][0]; ?>.
	<?     }
      else
    {
?>
	<p align="center">You selected to purchase a <?       echo $_POST["aircraft"]; ?> at $<?       echo $FormatNumber[$itemcost][0]; ?>.</p>
	<p align="center">
	<p align="center">
	<br>
	<!--#include file="activitycheck.php" -->
	<input type="hidden" name="process" value="1">
	<input type="submit" class="Buttons" name="Submit" value="Confirm Purchase">
	<?     } ?>
	<br>
	&nbsp;</td>
	</tr>
...
// Final form processing
  ...
  if ($_GET["aircraft"]!="" && $totalaircraft<$aircraftlimit && $_POST["process"]==1)
  {
...
$rsAircraft["Nation_ID"]=$rsGuestbook["Nation_ID"];
      ...
      switch ($_GET["aircraft"])
      {
        case "Yakovlev Yak-9":
          ...
          $item_infras=$f1_infras;
          $item_tech=$f1_tech;
$rsAircraft["Yakovlev Yak-9"]=1;
                    break;
        case "P-51 Mustang":
          $itemcost=$f2;
          $item_infras=$f2_infras;
          $item_tech=$f2_tech;
$rsAircraft["P-51 Mustang"]=1;
                    break;
        case "F-86 Sabre":
          $itemcost=$f3;
          $item_infras=$f3_infras;
          $item_tech=$f3_tech;
$rsAircraft["F-86 Sabre"]=1;
                    break;
        case "Mikoyan-Gurevich MiG-15":
          $itemcost=$f4;
          $item_infras=$f4_infras;
          $item_tech=$f4_tech;
$rsAircraft["Mikoyan-Gurevich MiG-15"]=1;
                    break;
        case "F-100 Super Sabre":
          $itemcost=$f5;
          $item_infras=$f5_infras;
          $item_tech=$f5_tech;
$rsAircraft["F-100 Super Sabre"]=1;
                    break;
        case "F-35 Lightning II":
          $itemcost=$f6;
          $item_infras=$f6_infras;
          $item_tech=$f6_tech;
$rsAircraft["F-35 Lightning II"]=1;
                    break;
        case "F-15 Eagle":
          $itemcost=$f7;
          $item_infras=$f7_infras;
          $item_tech=$f7_tech;
$rsAircraft["F-15 Eagle"]=1;
                    break;
        case "Su-30 MKI":
          $itemcost=$f8;
          $item_infras=$f8_infras;
          $item_tech=$f8_tech;
$rsAircraft["Su-30 MKI"]=1;
                    break;
        case "F-22 Raptor":
          $itemcost=$f9;
          $item_infras=$f9_infras;
          $item_tech=$f9_tech;
$rsAircraft["F-22 Raptor"]=1;
        ...
        case "AH-1 Cobra":
          ...
          $item_infras=$f1_infras;
          $item_tech=$f1_tech;
$rsAircraft["AH-1 Cobra"]=1;
                    break;
        case "AH-64 Apache":
          $itemcost=$b2;
          $item_infras=$f2_infras;
          $item_tech=$f2_tech;
$rsAircraft["AH-64 Apache"]=1;
                    break;
        case "Bristol Blenheim":
          $itemcost=$b3;
          $item_infras=$f3_infras;
          $item_tech=$f3_tech;
$rsAircraft["Bristol Blenheim"]=1;
                    break;
        case "B-25 Mitchell":
          $itemcost=$b4;
          $item_infras=$f4_infras;
          $item_tech=$f4_tech;
$rsAircraft["B-25 Mitchell"]=1;
                    break;
        case "B-17G Flying Fortress":
          $itemcost=$b5;
          $item_infras=$f5_infras;
          $item_tech=$f5_tech;
$rsAircraft["B-17G Flying Fortress"]=1;
                    break;
        case "B-52 Stratofortress":
          $itemcost=$b6;
          $item_infras=$f6_infras;
          $item_tech=$f6_tech;
$rsAircraft["B-52 Stratofortress"]=1;
                    break;
        case "B-2 Spirit":
          $itemcost=$b7;
          $item_infras=$f7_infras;
          $item_tech=$f7_tech;
$rsAircraft["B-2 Spirit"]=1;
                    break;
        case "B-1B Lancer":
          $itemcost=$b8;
          $item_infras=$f8_infras;
          $item_tech=$f8_tech;
$rsAircraft["B-1B Lancer"]=1;
                    break;
        case "Tupolev Tu-160":
          $itemcost=$b9;
          $item_infras=$f9_infras;
          $item_tech=$f9_tech;
$rsAircraft["Tupolev Tu-160"]=1;
                    break;
      } 
