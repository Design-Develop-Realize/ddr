...
$rsGuestbookSQL="SELECT Last_Tax_Collection,Strength,Cruise_Purchased,Poster,Nation_ID,Nation_Name,Nation_Dated,Nation_Team,Land_Purchased,Infrastructure_Purchased,Technology_Purchased,Nuclear_Purchased,Nation_Peace,Nuclear FROM Nation Where Nation_Peace = 1 AND  getdate() - Nation_Peace_Date > 5 ORDER BY Strength DESC ";
echo 3;
echo 2;
echo 3;
...
All Peaceful Nations By Strength Rank</b><? if (!($rsGuestbook==0) || !($rsGuestbook_BOF==1))
{
?>
                              </p>
                              <p align="center">
...
<?   echo mysql_num_rows($rsGuestbook_query); ?> Peaceful Nations
