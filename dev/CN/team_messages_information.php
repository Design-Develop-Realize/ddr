...
$rsGuestbook0SQL="SELECT Nation_Team FROM Nation WHERE POSTER = '"+str_replace("'","''",$rsUser__MMColParam)+"'";
echo 0;
echo 2;
echo 3;
...
?>
<? 
$messageteam=$rsGuestbook0["Nation_Team"];
$messageall="All";
// $rsSent is of type "ADODB.Recordset"

$rsSentSQL="SELECT * FROM Team_News Where Team = '".$messageteam."' OR Team = '".$messageall."' ORDER BY  Entry_Date DESC,Priority DESC";
echo 0;
echo 2;
echo 3;
...
<p><b>
<?   if ($rsGuestbook0["Nation_Team"]="None"$then; )
  {

    $You$are$not$part$of$a$team    $receive$team$messages$but$you$may$receive$general$announcements$from$the$Cyber$Nations$administration$in$this->fromstrftime("%H:%M:%S %p")$time->
<$%else; ?>
<center>
<?     echo $rsGuestbook0["Nation_Team"]; ?> Team Messages
...
<?     if ($access==1)
    {
?>
<img border="0" src="http://cybernations.net/images/ico_arr_gray.gif" width="11" height="11"> Top 3 Team Senators: <a href="team_messages.php">Compose New Team Message</a>
<?     } ?>
</center>
</p>
<?   } ?>
...
<tr> 
<td width="62%">Team Messages: <?     echo ($rsSent_first); ?> to <?     echo ($rsSent_last); ?> of <?     echo ($rsSent_total); ?> </td>
