...
$rsGuestbook0SQL="SELECT Nation_ID,Strength FROM Nation WHERE POSTER = '"+str_replace("'","''",$rsUser__MMColParam)+"'";
echo 0;
echo 2;
echo 3;
...
<div align="center">
<a href="nation_drill_display.asp?Nation_ID=<? echo $rsGuestbook["Nation_ID"]; ?>">Standard Display</a> | 
<a href="nation_drill_display.asp?Nation_ID=<? echo $rsGuestbook["Nation_ID"]; ?>&Extended=1">Extended Display</a>
<br>
...
<a href="declarewar_form.asp?Nation_ID=<?     echo $rsGuestbook["Nation_ID"]; ?>&bynation=<?     echo ($rsGuestbook0["Nation_ID"].$Value); ?>">Declare War</a> 
| 
<a href="trade_form.asp?Nation_ID=<?     echo $rsGuestbook0["Nation_ID"]; ?>&bynation=<?     echo ($rsGuestbook["Nation_ID"].$Value); ?>">Trade</a> | 
<a href="aid_form.asp?Nation_ID=<?     echo $rsGuestbook0["Nation_ID"]; ?>&bynation=<?     echo ($rsGuestbook["Nation_ID"]); ?>">
Aid</a> | 
...
<?   if ($Princeps==1)
  {
?>
<center><img border="0" src="http://images.cybernations.net/images/5gold.jpg" title="Team Princeps Leader">
<?     if (strtoupper($rsUser->Fields.$Item["U_ID"].$Value)==strtoupper($rsGuestbook["POSTER"].$Value))
    {
?>
<br><a href="team_messages.php">Send your team bulletin messages.</a>
<?     } ?>
</center><br>
<?     echo $rsGuestbook["Poster"]; ?> ruler of <?     echo $rsGuestbook["Nation_Name"]; ?> has been elected as the Princeps for the <?     echo $rsGuestbook["Nation_Team"]; ?> 
Team and has a great responsibility for running <?     echo $rsGuestbook["Nation_Team"]; ?>  Team matters.
Through this elected position <?     echo $rsGuestbook["Poster"]; ?> has the ability to view more information about other nations around the world than normal.
<?     echo $rsGuestbook["Nation_Name"]; ?> also receives a population happiness boost of +3 due to the great prestige of the Princeps position.
<p></p>
<?   } ?>
<?   if ($Praetor==1)
  {
?>
<center><img border="0" src="http://images.cybernations.net/images/4gold.jpg" title="Team Praetor Leader">
<?     if (strtoupper($rsUser->Fields.$Item["U_ID"].$Value)==strtoupper($rsGuestbook["POSTER"].$Value))
    {
?>
<br><a href="team_messages.php">Send your team bulletin messages.</a>
...
<?     echo $rsGuestbook["Poster"]; ?> ruler of <?     echo $rsGuestbook["Nation_Name"]; ?> has been elected as the current Praetor for the <?     echo $rsGuestbook["Nation_Team"]; ?> Team. This elected position acts as the Vice Princeps for the <?     echo $rsGuestbook["Nation_Team"]; ?> Team. 
Through this elected position <?     echo $rsGuestbook["Poster"]; ?> has the ability to view more information about other nations around the world than normal.
<?     echo $rsGuestbook["Nation_Name"]; ?> also receives a population happiness boost of +2 due to the high prestige of the Praetor position.
<?     if (strtoupper($rsUser->Fields.$Item["U_ID"].$Value)==strtoupper($rsGuestbook["POSTER"].$Value))
    {
?>
- <a href="team_messages.php">Send your team bulletin messages.</a>
<?     } ?>
<p></p>
<?   } ?>
<?   if ($Counslus==1)
  {
?>
<center><img border="0" src="http://images.cybernations.net/images/3gold.jpg" title="Team Counslus Leader">
<?     if (strtoupper($rsUser->Fields.$Item["U_ID"].$Value)==strtoupper($rsGuestbook["POSTER"].$Value))
    {
?>
<br><a href="team_messages.php">Send your team bulletin messages.</a>
...
<?     echo $rsGuestbook["Poster"]; ?> ruler of <?     echo $rsGuestbook["Nation_Name"]; ?> has been elected as the current Counslus for the <?     echo $rsGuestbook["Nation_Team"]; ?> Team. The Counslus position acts as a 
counselor to the <?     echo $rsGuestbook["Nation_Team"]; ?> Team Princeps and Praetor.
Due to the prestige of this position <?     echo $rsGuestbook["Nation_Name"]; ?> receives a receives a population happiness boost of +1.
<?     if (strtoupper($rsUser->Fields.$Item["U_ID"].$Value)==strtoupper($rsGuestbook["POSTER"].$Value))
    {
?>
- <a href="team_messages.php">Send your team bulletin messages.</a>
