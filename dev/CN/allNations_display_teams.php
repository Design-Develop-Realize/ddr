...
$rsGuestbookSQL="SELECT Last_Tax_Collection,Poster,Nation_ID,Nation_Name,Nation_Dated,Nation_Team,Land_Purchased,Infrastructure_Purchased,Technology_Purchased,Nuclear_Purchased,Nation_Peace,Nuclear FROM Nation Where Nation_Team = '"+$lngRecordNo+"' "+$tfm_SQLstr+" ORDER BY "+str_replace("'","''",$rsGuestbook__sql_orderby)+"";
echo 3;
echo 2;
echo 3;
...
<a href="allNations_display_teams.php?Team=None">No Team</a>
                              ...
                              <table width="100%" border="0">
                                <tr> 
                                  <td width="62%">
							Serving <?   echo ($rsGuestbook_first); ?> to <?   echo ($rsGuestbook_last); ?> of 
