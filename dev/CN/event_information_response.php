...
$lngRecordNo3=intval($_GET["Response"]);


if ($lngRecordNo0!=$rsGuestbookHead["Nation_ID"])
{
...
if ($lngRecordNo3!=0 && $lngRecordNo3!=1 && $lngRecordNo3!=2)
{

  $denyreason_session="That is an incorrect event response.";
  header("Location: "."activity_denied.asp");
} 
...
//National_Event_Response") = lngRecordNo3
