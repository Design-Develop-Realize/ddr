...
echo "SELECT *  FROM EMESSAGES  WHERE  MESS_DATE > getdate()-7 AND  U_ID = '"+str_replace("'","''",$rsMess__MMColParam)+"'  ORDER BY MESS_DATE DESC";
echo 0;
echo 2;
echo 3;
$rs=mysql_query();
...
// end rsUser.EOF And rsUser.BOF  $rsUser->EOF|$Not$rsUser->BOF$Then; ?>
                  ...
                  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#000080">
                    <tr> 
                      ...
                      &nbsp;:. <? echo ($rsUser->Fields.$Item["U_ID"].$Value); ?>'s Inbox </font></b></font></td>
                    </tr>
                    <tr> 
