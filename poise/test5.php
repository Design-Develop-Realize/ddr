...
// Init DB connection
			...
			// Acquire member info
			$querystr = "SELECT rulername, nation_id, nationstrength, warchest, brigade, infra, tech, nukes, spies, mp, sdi, pent, wrc, fafb, aadn, hnms, warpeace, wc_compliance, tier FROM member WHERE Brigade = 'Unknown'";
